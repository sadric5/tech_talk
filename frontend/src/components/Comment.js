        ...
        <div className="row form-control-plaintext collapse" id={"your-comment"+props.id.id }>
            <div className='row'>
                <div className="input-group my-2">
                    ...
                    <textarea maxLength={200} id="tweet-comment" value="" name="tweet" className="form-control border border-1 overflow-hidden border border-0 border-top-1 rounded"  aria-label="With textarea" placeholder="Any comment?" style={{backgroundColor:"#D7DAE0", resize:"none", overflow:"hidden", outlineStyle:"none", border:"none"}}> </textarea>
                    <span className="input-group-text btn border-0" style={{backgroundColor:"#fff", border:'none'}}> <i className="material-icons">send</i> </span>
                </div>
            </div>
