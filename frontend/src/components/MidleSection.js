    ...
    return (
        ...
        <div className='row m-2 border-secondary border-1'>
            <div className='col-lg-3'>
                <img className='rounded-circl' src='../../static/frontend/image/wc1.png'/>
        ...
        <div key={item.id} href="chart" className='row p-4 m-2 rounded-2' style={{backgroundColor:"white"}}>
            <div className='col-2 pe-2'>
                <img className='rounded-circle' style={{height:"50px", width:'50'}} src='../../static/frontend/image/face.png'/>
            </div>
            {/* Tweet, comment, like display */}
            <div className='col-10'>
                <div className='row '>
                    <div className='row m-1 fw-bold'>
                        ...
                        <div className='row'>
                            <form onSubmit={(e)=>handleNewComment(e, item.id)}>
                                <div className="input-group my-2">
                                    <img className='rounded-circle me-2' style={{height:"50px", width:'50'}} src='../../static/frontend/image/wc1.png'/>
